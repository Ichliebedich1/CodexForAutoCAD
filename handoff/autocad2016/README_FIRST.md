...
因此当前准确结论是：**AutoCAD 2016 诊断编译/NETLOAD 兼容候选已经成立；完整 AutoCAD 2016 支持尚未成立。** Palette、真实 AgentHost、认证 Bridge、选择上下文、审批及 CAD 事务写入仍未在 AutoCAD 2016 内完成端到端验证。
...
| AutoCAD 2016 完整产品支持 | 未成立 | 仍缺 Palette、只读上下文、Agent/Bridge、审批写入、生命周期和发布验证 |
...
2. 将 PaletteSet/WPF 接入 `Host.2016`，实测打开、停靠、浮动、隐藏、重开、中文输入、100%/125%/150% DPI、文档切换和 AutoCAD 退出。
