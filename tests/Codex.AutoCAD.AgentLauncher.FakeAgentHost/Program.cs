...
internal static class FakeAgentHostProgram
{
    ...
    private static void WaitForExitSignal()
    {
        ...
        // The inherited-handle launcher is Windows-only; this FakeAgentHost mode runs only under
        // its Windows integration gate, where a named EventWaitHandle is available.
